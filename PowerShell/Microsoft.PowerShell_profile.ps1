...
function allupgrade() {
	...
	Write-Host "# cargo" -ForegroundColor Magenta
...
# Git completion
Import-Module C:\Users\ShutoTanabashi\scoop\apps\posh-git\current\posh-git.psd1

# cargo (rust builder) completion
