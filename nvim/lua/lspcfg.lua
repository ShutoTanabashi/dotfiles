...
-- keymaps
--[[ 
vim.keymap.set("n", "gv", vim.diagnostic.open_float) -- Now builtined as `<C-W>d`
vim.keymap.set("n", "[g", vim.diagnostic.goto_prev) -- Now builtined as `[d`
vim.keymap.set("n", "]g", vim.diagnostic.goto_next) -- Now builtined as `]d`
]]
